...
const MY_CONTRACT_ADDRESS = "0x825a5e684B2DbaeF51194446d3Eb9370dF6A01F1"
...
const onContractInitCallback = async () => {
  ...
  */
  document.getElementById("contract_state").textContent = "Contract address in Sepolia: 0x825a5e684B2DbaeF51194446d3Eb9370dF6A01F1";
}
...
const mint = async () => {
  const result = await my_contract.methods.mint()
